...
import dev.vinpol.nebula.javaGOAP.graph.WeightedPath;
...
public abstract class GoapPlanner implements IGoapPlanner {
    ...
    protected void addVertices(IWeightedGraph<GraphNode, WeightedEdge> graph, List<GoapState> goalState) {
        ...
        GraphNode start = new GraphNode(null, new HashSet<>(this.goapUnit.getWorldState()));
     ...
     * @param endNodes the end nodes, to which paths inside the graph lead to.
     */
